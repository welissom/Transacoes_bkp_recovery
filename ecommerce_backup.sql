...
--
-- Dumping data for table `backup_clients`
--

LOCK TABLES `backup_clients` WRITE;
/*!40000 ALTER TABLE `backup_clients` DISABLE KEYS */;
INSERT INTO `backup_clients` VALUES (3,'Aparecida','P','Carvalho','12880516382','Rua Leôncio Barbosa, 619 - Ernani Sátiro');
/*!40000 ALTER TABLE `backup_clients` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `backup_product` (
  ...
  `classification_kids` tinyint(1) DEFAULT NULL,
  `category` enum('Eletrônico','Vestimenta','Brinquedos','Alimentos','Móveis') DEFAULT NULL,
  `avaliation` float DEFAULT NULL,
...
LOCK TABLES `backup_product` WRITE;
/*!40000 ALTER TABLE `backup_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `backup_product` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clients` VALUES (1,'Maria','M','Silva','123456789','rua silva de prata 29, Carangola - Cidade das Flores'),(2,'Matheus','O','Pimentel','987654321','rua alameda 289, Centro - Cidade das Flores'),(3,'Ricardo','F','Silva','45678913','avenida alameda vinha 1009, centro - Cidade das Flores'),(4,'Julia','S','França','789123456','rua laranjeiras 861, centro - Cidade das Flores'),(7,'Adriana','L','Pereira','74993676816','Rua Laurindo Cerqueira, 688 - Luzia'),(8,'Bryan','D','Pinto','14317089173','Rua Leôncio Barbosa, 691 - Tancredo Neves'),(10,'Teresinha','A','Paula','84423957094','Travessa Nova Brasília, s/n - Centro');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `bkp_clients` BEFORE DELETE ON `clients` FOR EACH ROW begin
...
INSERT INTO `orders` VALUES (5,1,'Em processamento','compra via aplicativo',200,1),(6,2,'Em processamento','compra via aplicativo',50,0),(7,3,'Confirmado',NULL,NULL,1),(8,4,'Em processamento','compra via web site',150,0),(9,2,'Em processamento','compra via aplicativo',NULL,1);
...
INSERT INTO `seller` VALUES (1,'Tech eletronics',NULL,'123456789456321',NULL,'Rio de Janeiro','219946287',1320),(2,'Botique Durgas',NULL,NULL,'123456783','Rio de Janeiro','219567895',1200),(3,'kids world',NULL,'456789123654485',NULL,'São Paulo','1198657484',1200);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comission_seller` BEFORE UPDATE ON `seller` FOR EACH ROW begin
...
INSERT INTO `supplier` VALUES (1,'Almeida e flihos','123456789123456','21985474'),(2,'Eletrônicos Silva','854519649143457','21985484'),(3,'Eletrônicos Valma','934567893934695','21975474');
...
-- Dump completed on 2022-10-31 17:15:34
